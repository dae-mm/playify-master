        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 3;
              return (0, _spotifyApi_actions.removeTrackFromPlaylistCall)(ownerId, playlistId, spotifyURI, dispatch);
...
var TOGGLE_SHUFFLE = exports.TOGGLE_SHUFFLE = 'toggle_shuffle';
...
var setupAuthToAPI = exports.setupAuthToAPI = function setupAuthToAPI(token) {
  return function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch) {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              (0, _spotifyApi_actions.setAccessToken)(token, dispatch);
...
var setAccessToken = exports.setAccessToken = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(token, dispatch) {
    var a_token;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function setAccessToken(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return _axios2.default.get(BASE_URL + '/me', {
              headers: {
...
var fetchTopTracks = exports.fetchTopTracks = function () {
  ...
  return function fetchTopTracks(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
...
var fetchTopArtists = exports.fetchTopArtists = function () {
  ...
  return function fetchTopArtists(_x5) {
    return _ref4.apply(this, arguments);
  };
}();
...
var fetchPlaylists = exports.fetchPlaylists = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(userId, dispatch) {
    var token, authString;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context5.next = 4;
            return _axios2.default.get(BASE_URL + ('/users/' + userId + '/playlists'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function fetchPlaylists(_x6, _x7) {
    return _ref5.apply(this, arguments);
  };
}();

var fetchFeaturedPlaylists = exports.fetchFeaturedPlaylists = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(timestamp, dispatch) {
    var token, authString;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context6.next = 4;
            return _axios2.default.get(BASE_URL + '/browse/featured-playlists?country=US&locale=sv_US&limit=5', {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function fetchFeaturedPlaylists(_x8, _x9) {
    return _ref6.apply(this, arguments);
  };
}();
...
var fetchNewReleases = exports.fetchNewReleases = function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context7.next = 4;
            return _axios2.default.get(BASE_URL + '/browse/new-releases?country=US', {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function fetchNewReleases(_x10) {
    return _ref7.apply(this, arguments);
  };
}();

var createUserPlaylist = exports.createUserPlaylist = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(userId, name, desc, dispatch) {
    var token, authString;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context8.next = 4;
            return _axios2.default.post(BASE_URL + ('/users/' + userId + '/playlists'), {
              name: name,
              description: desc
            }, {
              headers: {
              ...
              dispatch((0, _alert_actions.showSuccessAlert)(name + ' Playlist Created!'));
            }, function (err) {
              console.log('Something went wrong!', err);
              dispatch((0, _alert_actions.showErrorAlert)(name + ' playlist not created...'));
            });
  ...
  return function createUserPlaylist(_x11, _x12, _x13, _x14) {
    return _ref8.apply(this, arguments);
  };
}();

var unfollowPlaylistCall = exports.unfollowPlaylistCall = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(ownerId, playlistId, dispatch) {
    var token, authString;
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context9.next = 4;
            return _axios2.default.delete(BASE_URL + ('/users/' + ownerId + '/playlists/' + playlistId + '/followers'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
              ...
              dispatch((0, _alert_actions.showSuccessAlert)('Unfollowed a playlist!'));
            }, function (err) {
              console.log('Something went wrong!', err);
              dispatch((0, _alert_actions.showErrorAlert)('Could not unfollow playlist'));
            });
  ...
  return function unfollowPlaylistCall(_x15, _x16, _x17) {
    return _ref9.apply(this, arguments);
  };
}();

var followPlaylistCall = exports.followPlaylistCall = function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(ownerId, playlistId, dispatch) {
    var token, authString;
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context10.next = 4;
            return _axios2.default.put(BASE_URL + ('/users/' + ownerId + '/playlists/' + playlistId + '/followers'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
              ...
              dispatch((0, _alert_actions.showSuccessAlert)('You followed a playlist!'));
            }, function (err) {
              console.log('Something went wrong!', err);
              dispatch((0, _alert_actions.showErrorAlert)('could not follow the playlist'));
            });
  ...
  return function followPlaylistCall(_x18, _x19, _x20) {
    return _ref10.apply(this, arguments);
  };
}();

var deleteUserPlaylist = exports.deleteUserPlaylist = function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(userId, playlistId, dispatch) {
    var token, authString;
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context11.next = 4;
            return _axios2.default.delete(BASE_URL + ('/users/' + userId + '/playlists/' + playlistId + '/followers'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
              ...
              dispatch((0, _alert_actions.showSuccessAlert)('Deleted the playlist'));
            }, function (err) {
              console.log('Something went wrong!', err);
              dispatch((0, _alert_actions.showErrorAlert)('could not delete the playlist'));
            });
  ...
  return function deleteUserPlaylist(_x21, _x22, _x23) {
    return _ref11.apply(this, arguments);
  };
}();
...
var fetchTrack = exports.fetchTrack = function () {
  ...
  return function fetchTrack(_x24) {
    return _ref12.apply(this, arguments);
  };
}();
var fetchTrackDetails = exports.fetchTrackDetails = function () {
  ...
  return function fetchTrackDetails(_x25) {
    return _ref13.apply(this, arguments);
  };
}();

var getTracklistOfPlaylist = exports.getTracklistOfPlaylist = function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(userId, playlistId, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context14.next = 4;
            return _axios2.default.get(BASE_URL + ('/users/' + userId + '/playlists/' + playlistId), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function getTracklistOfPlaylist(_x26, _x27, _x28) {
    return _ref14.apply(this, arguments);
  };
}();

var addTrackToPlaylistCall = exports.addTrackToPlaylistCall = function () {
  var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(ownerId, playlistId, spotifyURI, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context15.next = 4;
            return _axios2.default.post(BASE_URL + ('/users/' + ownerId + '/playlists/' + playlistId + '/tracks'), {
              uris: [spotifyURI]
            }, {
              headers: {
                Accept: 'application/json',
              ...
              dispatch((0, _alert_actions.showSuccessAlert)('Added tracks to playlist!'));
            }, function (err) {
              console.log('Something went wrong!', err);
              dispatch((0, _alert_actions.showErrorAlert)('Could not add tracks to playlist'));
            });
  ...
  return function addTrackToPlaylistCall(_x29, _x30, _x31, _x32) {
    return _ref15.apply(this, arguments);
  };
}();

var removeTrackFromPlaylistCall = exports.removeTrackFromPlaylistCall = function () {
  var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(ownerId, playlistId, spotifyURI, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context16.next = 4;
            return _axios2.default.delete(BASE_URL + ('/users/' + ownerId + '/playlists/' + playlistId + '/tracks'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              },
              ...
              dispatch((0, _alert_actions.showSuccessAlert)('Track removed from playlist!'));
            }, function (err) {
              console.log('Something went wrong!', err);
              dispatch((0, _alert_actions.showErrorAlert)('Could not remove track from playlist'));
            });
  ...
  return function removeTrackFromPlaylistCall(_x33, _x34, _x35, _x36) {
...
var getCategoriesCall = exports.getCategoriesCall = function () {
  ...
  return function getCategoriesCall(_x37) {
    return _ref17.apply(this, arguments);
  };
}();

var getActiveCategoryPlaylistsCall = exports.getActiveCategoryPlaylistsCall = function () {
  var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(category, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context18.next = 4;
            return _axios2.default.get(BASE_URL + ('/browse/categories/' + category + '/playlists?country=US'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function getActiveCategoryPlaylistsCall(_x38, _x39) {
...
var getSearchedTracksCall = exports.getSearchedTracksCall = function () {
  var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(word, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context19.prev = _context19.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context19.next = 4;
            return _axios2.default.get(BASE_URL + ('/search?q=' + word + '&type=track'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function getSearchedTracksCall(_x40, _x41) {
    return _ref19.apply(this, arguments);
  };
}();

var getSearchedArtistsCall = exports.getSearchedArtistsCall = function () {
  var _ref20 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(word, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context20.prev = _context20.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context20.next = 4;
            return _axios2.default.get(BASE_URL + ('/search?q=' + word + '&type=artist'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function getSearchedArtistsCall(_x42, _x43) {
    return _ref20.apply(this, arguments);
  };
}();

var getSearchedPlaylistsCall = exports.getSearchedPlaylistsCall = function () {
  var _ref21 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(word, dispatch) {
    var token, authString;
      ...
      while (1) {
        switch (_context21.prev = _context21.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context21.next = 4;
            return _axios2.default.get(BASE_URL + ('/search?q=' + word + '&type=playlist'), {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function getSearchedPlaylistsCall(_x44, _x45) {
...
var fetchAlbum = exports.fetchAlbum = function () {
  var _ref22 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22(id) {
    var token, authString;
  ...
  return function fetchAlbum(_x46) {
...
var fetchArtist = exports.fetchArtist = function () {
  var _ref23 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee23(id) {
    var token, authString;
  ...
  return function fetchArtist(_x47) {
...
var fetchArtistAlbums = exports.fetchArtistAlbums = function () {
  ...
  return function fetchArtistAlbums(_x48) {
    return _ref24.apply(this, arguments);
  };
}();

var fetchArtistTopTracks = exports.fetchArtistTopTracks = function () {
  var _ref25 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(id) {
    var token, authString;
      ...
      while (1) {
        switch (_context25.prev = _context25.next) {
          case 0:
            ...
            authString = 'Bearer ' + token;
            _context25.next = 4;
            return _axios2.default.get(BASE_URL + '/artists/' + id + '/top-tracks?country=US', {
              headers: {
                Accept: 'application/json',
                Authorization: authString
              }
  ...
  return function fetchArtistTopTracks(_x49) {
    return _ref25.apply(this, arguments);
  };
}();

var fetchRelatedArtists = exports.fetchRelatedArtists = function () {
  var _ref26 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(id) {
    var token, authString;
  ...
  return function fetchRelatedArtists(_x50) {
...
var Track = function (_Component) {
  ...
  function Track() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Track.__proto__ || Object.getPrototypeOf(Track)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.props.history.push('/app/tracks/' + _this.props.track.id);
      ...
      _this.props.history.push('/app/artists/' + id);
    }, _this.addTrackToQueuedList = function (track) {
      _this.props.addTrackToQueuedList(track);
      _this.toggleDropdown();
    }, _this.startTrack = function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(track) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
      ...
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(spotifyURI) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
...
var Home = function (_Component) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(newProps) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    }, _this.togglePlaylist = function () {
      if (_this.state.playlistClassName === 'column playlists-menu') {
        _this.setState({ playlistClassName: 'column playlists-menu active' });
      } else {
        _this.setState({ playlistClassName: 'column playlists-menu' });
      }
      ...
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, desc) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
  ...
  _createClass(Home, [{
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(newProps) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: this.state.playlistClassName },
...
var Search = function (_Component) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Search.__proto__ || Object.getPrototypeOf(Search)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.props.history.push('/app/playlists/' + userId + '/' + playlistId);
...
var Tracklist = function (_Component) {
  ...
  function Tracklist() {
    ...
    }, _this.followActivePlaylist = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
    ...
    })), _this.unfollowActivePlaylist = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
    ...
    })), _this.deleteActivePlaylist = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
    ...
    }, _this.playActiveTracklist = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
...
exports.default = [{
  ...
  component: function component() {
    return _react2.default.createElement(_reactRouter.Redirect, { from: '*', to: '/' });
  }
}];
...
module.exports = "data:image/png;base64,"
...
var AlbumDetail = function (_Component) {
  ...
  function AlbumDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AlbumDetail.__proto__ || Object.getPrototypeOf(AlbumDetail)).call.apply(_ref, [this].concat(args))), _this), _this.renderTracks = function (tracks) {
      return tracks.map(function (track, index) {
        var extraAttribut = {
          album: {
            images: [{
              url: _this.props.album.images[0] ? _this.props.album.images[0].url : null
            }]
          }
        };
        var newTrack = _extends({}, track, extraAttribut);
        return _react2.default.createElement(_Track2.default, {
          key: index,
          track: newTrack,
          isMyPlaylist: false,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                window.scroll(0, 0);
                _context.next = 3;
                return this.props.getAlbum(this.props.match.params.id);
              ...
              case 3:
                ...
                if (this.props.album.tracks) {
                  this.props.album.tracks.items.map(function (track) {
                    var extraAttribut = {
                      album: {
                        images: [{
                          url: _this2.props.album.images[0] ? _this2.props.album.images[0].url : null
                        }]
                      }
                    };
                    var newTrack = _extends({}, track, extraAttribut);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.props.album.images ? _react2.default.createElement('img', {
              src: this.props.album.images.length > 0 ? this.props.album.images[0].url : null
            }) : null
          )
        ),
        _react2.default.createElement(
          'ul',
          null,
          this.props.album.tracks ? this.renderTracks(this.props.album.tracks.items) : null
        )
      );
    }
  }]);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, {
  ...
  getAlbum: _album_actions.getAlbum,
  setActiveTracklistSolo: _track_actions.setActiveTracklistSolo
})(AlbumDetail));
...
var ArtistDetail = function (_Component) {
  ...
  function ArtistDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ArtistDetail.__proto__ || Object.getPrototypeOf(ArtistDetail)).call.apply(_ref, [this].concat(args))), _this), _this.getArtistDetail = function () {
      ...
      _this.props.history.push('/app/albums/' + id);
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.unlisten = this.props.history.listen(function (location, action) {
                  var incID = location.pathname.slice(13);
                  var artists = location.pathname.slice(5, 12);
...
var Discover = function (_Component) {
  ...
  function Discover() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Discover.__proto__ || Object.getPrototypeOf(Discover)).call.apply(_ref, [this].concat(args))), _this), _this.componentWillMount = function () {
      ...
      _this.props.history.push('/app/discover/' + id);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _this.props.setupAuthToAPI(event.data.access_token);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('p', { id: 'slide-two' }),
              _react2.default.createElement(
                'h2',
                { id: 'slide-three' },
                'Playlists'
              ),
              _react2.default.createElement('p', { id: 'slide-three' }),
              _react2.default.createElement(
                'h2',
                { id: 'slide-four' },
                'New releases'
              ),
              _react2.default.createElement('p', { id: 'slide-four' })
            )
          ),
          _react2.default.createElement(
            'section',
...
var _screenfull = __webpack_require__(71);
...
var MusicBar = function (_Component) {
  ...
  function MusicBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MusicBar.__proto__ || Object.getPrototypeOf(MusicBar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.props.history.push('/app/tracks/' + _this.props.activeTrack.id);
    }, _this.navigateToArtistDetailPage = function (id) {
      _this.props.history.push('/app/artists/' + id);
...
var Nav = function (_Component) {
  ...
  function Nav() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Nav.__proto__ || Object.getPrototypeOf(Nav)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.state.mobileMenu === 'mobile-links-menu') {
        _this.setState({ mobileMenu: 'mobile-links-menu active' });
      } else {
        _this.setState({ mobileMenu: 'mobile-links-menu' });
      }
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { onClick: function onClick() {
              return _this2.toggleMobileMenu();
            }, className: 'burge-menu' },
          this.state.mobileMenu === 'mobile-links-menu' ? _react2.default.createElement('i', { className: 'fa fa-bars', 'aria-hidden': 'true' }) : _react2.default.createElement('i', { className: 'fa fa-times', 'aria-hidden': 'true' })
        ),
        _react2.default.createElement(
          'div',
          { className: this.state.mobileMenu },
          _react2.default.createElement(
            _reactRouterDom.NavLink,
            {
              className: 'navbar-item',
...
var NewReleases = function (_Component) {
  ...
  function NewReleases() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NewReleases.__proto__ || Object.getPrototypeOf(NewReleases)).call.apply(_ref, [this].concat(args))), _this), _this.navigateToDetailPage = function (release) {
      _this.props.history.push('/app/albums/' + release.id);
...
var PlaylistDetail = function (_Component) {
  ...
  function PlaylistDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PlaylistDetail.__proto__ || Object.getPrototypeOf(PlaylistDetail)).call.apply(_ref, [this].concat(args))), _this), _this.setActivePlaylist = function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ownerId, playlistId) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
  ...
  _createClass(TrackDetail, [{
    ...
    value: function componentDidMount() {
      ...
      this.unlisten = this.props.history.listen(function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(location, action) {
          var incID, word;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  incID = location.pathname.slice(12);
                  word = location.pathname.slice(5, 11);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              { className: 'tracklist-name title' },
              this.props.activeTracklist.name ? this.props.activeTracklist.name : 'Tracks'
            )
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                'Made by:',
                ' ',
                this.props.activeTracklist.owner ? this.props.activeTracklist.owner.display_name || this.props.activeTracklist.owner.id : 'Unknown',
                ' '
              )
            ),
            _react2.default.createElement(
...
var _reduxPersist = __webpack_require__(69);
