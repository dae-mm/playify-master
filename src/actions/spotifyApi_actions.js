...
export const fetchFeaturedPlaylists = async (timestamp, dispatch) => {
  ...
  return await axios
    .get(
      BASE_URL + `/browse/featured-playlists?country=US&locale=sv_US&limit=5`,
      {
        headers: {
          Accept: 'application/json',
          Authorization: authString
...
export const fetchNewReleases = async dispatch => {
  ...
  return await axios
    .get(BASE_URL + `/browse/new-releases?country=US`, {
      headers: {
        Accept: 'application/json',
        Authorization: authString
      }
  ...
  await axios
    ...
    .then(
      data => {
        ...
        dispatch(showSuccessAlert(name + ' Playlist Created!'))
      },
      err => {
        console.log('Something went wrong!', err)
        dispatch(showErrorAlert(name + ' playlist not created...'))
      }
    )
}
  ...
  await axios
    ...
    .then(
      data => {
        ...
        dispatch(showSuccessAlert('Unfollowed a playlist!'))
      },
      err => {
        console.log('Something went wrong!', err)
        dispatch(
          showErrorAlert('Could not unfollow playlist')
        )
      }
    )
}
  ...
  await axios
    ...
    .then(
      data => {
        ...
        dispatch(showSuccessAlert('You followed a playlist!'))
      },
      err => {
        console.log('Something went wrong!', err)
        dispatch(showErrorAlert('could not follow the playlist'))
      }
    )
}
  ...
  await axios
    ...
    .then(
      data => {
        ...
        dispatch(showSuccessAlert('Deleted the playlist'))
      },
      err => {
        console.log('Something went wrong!', err)
        dispatch(showErrorAlert('could not delete the playlist'))
      }
    )
}
  ...
  await axios
    ...
    .then(
      data => {
        ...
        dispatch(showSuccessAlert('Added tracks to playlist!'))
      },
      err => {
        console.log('Something went wrong!', err)
        dispatch(showErrorAlert('Could not add tracks to playlist'))
      }
    )
}
  ...
  await axios
    ...
    .then(
      data => {
        ...
        dispatch(showSuccessAlert('Track removed from playlist!'))
      },
      err => {
        console.log('Something went wrong!', err)
        dispatch(
          showErrorAlert('Could not remove track from playlist')
        )
      }
    )
}
...
export const getActiveCategoryPlaylistsCall = async (category, dispatch) => {
  ...
  return await axios
    .get(BASE_URL + `/browse/categories/${category}/playlists?country=US`, {
      headers: {
        Accept: 'application/json',
        Authorization: authString
      }
...
export const fetchArtistTopTracks = async id => {
  ...
  return await axios
    .get(`${BASE_URL}/artists/${id}/top-tracks?country=US`, {
      headers: {
        Accept: 'application/json',
        Authorization: authString
      }
